...
class _SubscriptionPlansPageState extends State<SubscriptionPlansPage> {
  ...
  void _initiatePayment(BuildContext context, String planName, String amount) {
  ...
  Widget _buildPlanCard(BuildContext context, String planName, String displayAmount, String amount) {
    return Card(
